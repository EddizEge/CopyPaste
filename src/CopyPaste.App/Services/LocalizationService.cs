...
public static class LocalizationService
{
    ...
    [
        ...
        ("＋  Kuyruğa ekle", "＋  Add to queue"), ("Kuyruğa ekle", "Add to queue"),
        ("Önizle / karşılaştır", "Preview / compare"),
        ("Kuyruk", "Queue"), ("Transfer kuyruğu", "Transfer queue"),
        ...
        ("Önceki oturum beklenmedik şekilde kapandı. Ayarlar içinden tanılama paketi oluşturabilirsiniz.",
